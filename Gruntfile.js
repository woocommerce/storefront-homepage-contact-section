	...
	grunt.initConfig({
		...
		makepot: {
			options: {
				...
				potHeaders: {
					'report-msgid-bugs-to': 'https://wordpress.org/support/plugin/storefront-homepage-contact-section/',
					'language-team': 'LANGUAGE <EMAIL@ADDRESS>'
				}
			},
			frontend: {
				options: {
					potFilename: 'storefront-homepage-contact-section.pot',
					exclude: [
						'node_modules/.*'
					]
				}
		...
		checktextdomain: {
			options:{
				text_domain: 'storefront-homepage-contact-section',
				keywords: [
					'__:1,2d',
					'_e:1,2d',
					'_x:1,2c,3d',
		...
		compress: {
			zip: {
				options: {
					archive: './storefront-homepage-contact-section.zip',
					mode: 'zip'
				},
				files: [{
					src: [
						...
						'!package-lock.json',
						'!phpcs.xml',
						'!storefront-homepage-contact-section.zip',
